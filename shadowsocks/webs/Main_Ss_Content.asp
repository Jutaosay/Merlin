...
function save() {
	...
	var params = ["server", "mode", "port", "method", "ss_v2ray_plugin", "ss_v2ray_plugin_opts", "rss_protocol","naive_protocol", "naive_user","rss_protocol_param", "rss_obfs", "rss_obfs_param", "koolgame_udp", "v2ray_uuid", "v2ray_alterid", "v2ray_protocol", "v2ray_xray", "v2ray_security", "v2ray_network", "v2ray_headtype_tcp", "v2ray_headtype_kcp", "v2ray_network_host","v2ray_network_path", "v2ray_network_tlshost", "v2ray_network_flow", "v2ray_network_security", "v2ray_mux_concurrency","trojan_sni", "trojan_binary", "trojan_network", "hy2_obfs", "hy2_up_mbps", "hy2_down_mbps", "fingerprint","xray_publicKey", "xray_shortId"];
...
function verifyFields(r) {
	...
	showhide("hy2_obfs_basic_tr", (trojan_on && E("ss_basic_trojan_binary").value == "Hysteria2"));
	showhide("hy2_up_basic_tr", (trojan_on && E("ss_basic_trojan_binary").value == "Hysteria2"));
	showhide("hy2_down_basic_tr", (trojan_on && E("ss_basic_trojan_binary").value == "Hysteria2"));
	//mixed variables
...
//		showhide("ss_v2ray_plugin_opts", trojango_on_1);
		...
		var hy2_on_1 = E("ss_node_table_trojan_binary").value == "Hysteria2";
		showhide("hy2_obfs_tr", hy2_on_1);
		showhide("hy2_up_tr", hy2_on_1);
		showhide("hy2_down_tr", hy2_on_1);
	}
...
function ssconf_node2obj(node_sel) {
	...
	var p = "ssconf_basic";
	var obj = {};
	var params2 = ["password", "v2ray_json", "server", "mode", "port", "password", "method", "ss_v2ray_plugin", "ss_v2ray_plugin_opts", "koolgame_udp", "rss_protocol", "rss_protocol_param", "rss_obfs", "rss_obfs_param", "use_kcp", "v2ray_uuid", "v2ray_alterid", "v2ray_protocol", "v2ray_xray", "v2ray_security", "v2ray_network", "v2ray_headtype_tcp", "v2ray_headtype_kcp",  "v2ray_serviceName","v2ray_network_path", "v2ray_network_host", "v2ray_network_tlshost", "v2ray_network_flow","allowinsecure","fragment","v2ray_mux_enable", "v2ray_network_security", "v2ray_mux_concurrency", "v2ray_use_json", "trojan_binary", "trojan_network", "trojan_sni","naive_protocol", "naive_user","fingerprint","xray_publicKey","xray_shortId"];
...
function add_ss_node_conf(flag) { //点击添加按钮动作
	...
	var params4_1 = ["mode", "name", "server", "port", "v2ray_uuid", "v2ray_alterid", "v2ray_protocol", "v2ray_xray", "v2ray_security", "v2ray_network", "v2ray_headtype_tcp", "v2ray_headtype_kcp", "v2ray_serviceName", "v2ray_network_path", "v2ray_network_host", "v2ray_network_tlshost", "v2ray_network_flow", "v2ray_network_security", "v2ray_mux_concurrency","fingerprint","xray_publicKey", "xray_shortId"]; //for v2ray
	var params4_2 = ["v2ray_use_json", "v2ray_mux_enable","allowinsecure","fragment"]; //for v2ray
	var paramsTrojan = ["name", "server", "mode", "port","v2ray_network_path", "v2ray_network_host","trojan_sni","trojan_binary","trojan_network","hy2_obfs","hy2_up_mbps","hy2_down_mbps","allowinsecure","v2ray_mux_concurrency","fingerprint"]; //for trojan
	...
	$.ajax({
		...
		success: function(response) {
			...
			if ((E("continue_add_box").checked) == false) { //不选择连续添加的时候，清空其他数据
				...
				E("ss_node_table_trojan_network").value = "0";		
				E("ss_node_table_trojan_sni").value = "";
				E("ss_node_table_hy2_obfs").value = "";
...
function edit_conf_table(o) { //编辑节点功能，显示编辑面板
	...
	var params1_input = ["name", "server", "mode", "port", "method", "ss_v2ray_plugin", "ss_v2ray_plugin_opts", "rss_protocol", "rss_protocol_param", "rss_obfs", "rss_obfs_param", "koolgame_udp", "v2ray_uuid", "v2ray_alterid", "v2ray_protocol", "v2ray_xray", "v2ray_security", "v2ray_network", "v2ray_headtype_tcp", "v2ray_headtype_kcp","v2ray_serviceName", "v2ray_network_path", "v2ray_network_host", "v2ray_network_tlshost", "v2ray_network_flow", "v2ray_network_security", "v2ray_mux_concurrency", "trojan_sni", "hy2_obfs", "hy2_up_mbps", "hy2_down_mbps", "fingerprint", "naive_protocol", "naive_user","xray_publicKey", "xray_shortId"];
	if(c["v2ray_json"]){
...
function edit_ss_node_conf(flag) { //编辑节点功能，数据重写
	...
	var params4_1 = ["mode", "name", "server", "port", "v2ray_uuid", "v2ray_alterid", "v2ray_protocol", "v2ray_xray", "v2ray_security", "v2ray_network", "v2ray_headtype_tcp", "v2ray_headtype_kcp", "v2ray_serviceName","v2ray_network_path", "v2ray_network_host", "v2ray_network_tlshost", "v2ray_network_flow", "v2ray_network_security", "v2ray_mux_concurrency","fingerprint","xray_publicKey", "xray_shortId"]; //for v2ray
	var params4_2 = ["v2ray_use_json", "v2ray_mux_enable","allowinsecure","fragment"]; //for v2ray
	var paramsTrojan = ["name", "server", "mode", "port","trojan_binary", "trojan_network", "v2ray_network_path", "v2ray_network_host", "trojan_sni", "hy2_obfs", "hy2_up_mbps", "hy2_down_mbps", "fingerprint", "allowinsecure","fragment", "v2ray_mux_concurrency"]; //for trojan
