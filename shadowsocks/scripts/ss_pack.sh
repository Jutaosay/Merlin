...
TARGET_BIN="base64_encode cdns chinadns  chinadns1 chinadns-ng client_linux_arm5 dns2socks dnsmasq haproxy haveged httping https_dns_proxy jq koolbox koolgame pdu resolveip smartdns ss-local ss-redir ss-tunnel trojan-go naive hysteria v2ray v2ray-plugin obfs-local xray"
